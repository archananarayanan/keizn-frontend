...
const handleSearchChange = (e: { target: { value: string; }; }) => {
  ...
  return (
    <div className="flex w-full min-h-full px-1 align-center lg:px-2">
      <div className="fixed inset-0 bg-gray-500/30 bg-opacity-75 transition-opacity"></div>
      ...
      { stockModal && <div id="stock-modal" className="flex backdrop-blur transform overflow-y-auto overflow-x-hidden fixed align-center z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
      ...
      { categoryModal && <div id="category-modal" className="flex backdrop-blur transform overflow-y-auto overflow-x-hidden fixed align-center z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
        <div className="relative p-4 w-full max-w-2xl max-h-full">
          <div className="relative bg-white rounded-lg shadow dark:bg-gray-700">
            <div className="flex items-center justify-between p-4 md:p-5 border-b rounded-t dark:border-gray-600">
              <h3 className="text-xl font-semibold text-gray-900 dark:text-white">
      ...
      { tagModal && <div id="tag-modal" className="flex backdrop-blur transform overflow-y-auto overflow-x-hidden fixed align-center z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
        <div className="relative p-4 w-full max-w-2xl max-h-full">
          <div className="relative bg-white rounded-lg shadow dark:bg-gray-700">
            <div className="flex items-center justify-between p-4 md:p-5 border-b rounded-t dark:border-gray-600">
              <h3 className="text-xl font-semibold text-gray-900 dark:text-white">
